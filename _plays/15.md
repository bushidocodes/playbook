...
playid: 15
gear: high
title: Maximize use of vendor-agnostic services capable of deployment to alternative CSPs
---
...
but it most certainly does to operations, enterprise architects, and the IT executive team. As such, new high gear applications should maximize use of vendor-neutral subset of cloud capabilities offered by
...
gathering process to allow for cost-benefit analysis weighing functionality against lock-in, portfolio management, and integration work.
...
2. Work with the FCS program office to perform functional gap analysis and identify new services worth adding to the FCS contract.